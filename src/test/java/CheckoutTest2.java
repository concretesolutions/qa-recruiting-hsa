...
public class CheckoutTest2 {
    ...
    HashMap<String, Item> config = ListOfItems.getListOfItems("listItems2.conf");
    ...
    public void checkPriceAAAA(){
        ...
        Assert.assertEquals(210,basket.checkTotal(),0.0d);
    }
    ...
    public void checkPriceAAAAAA(){
        ...
        Assert.assertEquals(320,basket.checkTotal(),0.0d);
    }
    ...
    public void checkPriceAAABBD(){
        ...
        Assert.assertEquals(350,basket.checkTotal(),0.0d);
    }
